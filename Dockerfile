...
WORKDIR /main
COPY ["ControleDeMateriais.Api.csproj", "main/ControleDeMateriais/ControleDeMateriais.Api/"]
RUN dotnet restore "main/ControleDeMateriais/ControleDeMateriais.Api/ControleDeMateriais.Api.csproj"
COPY . .
